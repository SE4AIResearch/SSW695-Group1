...
func _on_sdlc_overview_pressed() -> void: prepPage("test")
func _on_agile_pressed() -> void: prepPage("test")
func _on_waterfall_pressed() -> void: prepPage("test")
func _on_project_constraints_pressed() -> void: prepPage("test")
func _on_stakeholder_management_pressed() -> void: prepPage("test")
func _on_sprint_planning_basics_pressed() -> void: prepPage("test")
func _on_risk_management_pressed() -> void: prepPage("test")
